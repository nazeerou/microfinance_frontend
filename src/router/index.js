...
// const CustomerCreate = () => import('@/views/customers/CustomerForm.vue')
// const CustomerDetail = () => import('@/views/customers/CustomerDetail.vue')
// const CustomerEdit = () => import('@/views/customers/CustomerEdit.vue')

// // // Loan pages
// const LoanList = () => import('@/views/loans/LoanList.vue')
// const LoanForm = () => import('@/views/loans/LoanForm.vue')
// const LoanDetail = () => import('@/views/loans/LoanDetail.vue')
// // const LoanApproval = () => import('@/views/loans/LoanApproval.vue')

// // // Payment pages
// const PaymentList = () => import('@/views/payments/PaymentList.vue')
// const RecordPayment = () => import('@/views/payments/RecordPayment.vue')
// // const PaymentDetail = () => import('@/views/payments/PaymentDetail.vue')

// // // Collateral pages
// const CollateralList = () => import('@/views/collaterals/CollateralList.vue')
// const CollateralDetail = () => import('@/views/collaterals/CollateralDetail.vue')

// // // Report pages
// const Report = () => import('@/views/reports/Report.vue')
// // const OutstandingLoans = () => import('@/views/reports/OutstandingLoans.vue')
// // const DefaultedLoans = () => import('@/views/reports/DefaultedLoans.vue')
// // const CustomerHistory = () => import('@/views/reports/CustomerHistory.vue')
...
// // const AuditTrail = () => import('@/views/audit/AuditTrail.vue')
...
// const routes = [
//   // Public routes (NO layout - just the component)
//   {
//     path: '/login',
//     name: 'Login',
//     component: Login,
